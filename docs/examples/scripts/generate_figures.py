...
folder_gain_fig = context.folder_ctx("folder")._figures["gain"]
folder_gain_fig.savefig(FIGURES_PATH / "folder_gain.png")
folder_resolution_fig = context.folder_ctx("folder")._figures["resolution"]
...
gain_trend_fig = context.folder_ctx("gain_trend")._figures["gain"]
